...
class IObservable(ABC):
    ...
    @abstractmethod
    def addObserver(self, observer: IObserver) -> None: raise NotImplementedError

    @abstractmethod
    def removeObserver(self, observer: IObserver) -> None: raise NotImplementedError

    @abstractmethod
    def notifyObservers(self) -> None: raise NotImplementedError
